...
public interface XPathListener extends ParseTreeListener {
	...
	/**
	 * Enter a parse tree produced by {@link XPathParser#eq}.
	 * @param ctx the parse tree
	 */
	void enterEq(XPathParser.EqContext ctx);
	/**
	 * Exit a parse tree produced by {@link XPathParser#eq}.
	 * @param ctx the parse tree
	 */
	void exitEq(XPathParser.EqContext ctx);
	/**
